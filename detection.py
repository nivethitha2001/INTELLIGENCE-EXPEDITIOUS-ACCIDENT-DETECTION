...
def helper():
    ...
    predict = dlib.shape_predictor("C:/Nivethitha/miniproj/shape_predictor_68_face_landmarks.dat")
        ...
        for subject in subjects:
            ...
            if mar > mouthThresh:
                ...
                if flag_mouth >= frame_check_mouth:
                    ...
                    time.sleep(5)
                    p = multiprocessing.Process(target=playsound, args=("C:/Nivethitha/miniproj/Alarm.wav",))
                    p.start()
                    time.sleep(10)
                    p.terminate()
                    notify = Notify()
                    notify.send("yawningggggggggggg")
            else:
                flag_mouth = 0
            ...
            if ear < eyeThresh:
                ...
                if flag_eye >= frame_check_eye:
                    ...
                    p.terminate()
                    notify = Notify()
                    notify.send("sleepinggggggggggggg")
            else:
                flag_eye = 0
